                ...
                <div class="inner-column" id="flip-card">
                    <div class="flip-card-front" style="padding-top: 10px;">
                        <div class="">
                            <div class="row">
                                <div class="col-md-10">
                                    <h1 class="left_border font_grey" style="float: left;font-size: 35px;">Add Products</h1>
                                </div>
                            </div>
                            <form name="companyinfo" id="companyinfo" enctype="multipart/form-data" class="form_class" data-parsley-validate autocomplete="off">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-xs-12 col-md-12">
                                            <div class="text-field-filled">
                                                <input class="effect-16" type="text" placeholder="" style="clear:both" id="product_name" name="product_name" data-parsley-trigger="blur" required="" data-parsley-errors-container=".errorscompany">
                                                <label>Product Name</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-xs-12 col-md-12">
                                            <div class="text-field-filled">
                                                <input class="effect-16" type="number" placeholder="" style="clear:both" id="product_price" name="product_price" data-parsley-trigger="blur" required="" data-parsley-errors-container=".errorsindustry">
                                                <label>Product Price</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-xs-12 col-md-12">
                                            <div class="text-field-filled">
                                                <input class="effect-16" type="text" placeholder="" style="clear:both" id="product_description" name="product_description" data-parsley-trigger="blur" required="" data-parsley-errors-container=".errorsheadadd">
                                        ...
                                        <div class="col-sm-12 col-xs-12 col-md-12">
                                                <!-- <div class="">
                                                    ...
                                                    <br>
                                                    <input class="effect-16" type="file" placeholder="" style="clear:both" id="files" name="files[]" data-parsley-trigger="blur" required="" data-parsley-errors-container=".errorsheadadd" multiple>
                                                </div>
                                            </div> -->
                                ...
                                <div style="margin: 15px 0px;text-align: center;">
                                    <button type="button" class="btn btn-dark" id="AddProduct" style="border: none;">Submit</button><img src="{{ asset('public/asset/images/pageloader.gif') }}" id="loading-image" style="display:none; width: 40px;">
                                </div>
                            </form>
                        </div>
                    </div>
